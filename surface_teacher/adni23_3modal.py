...
from q_pytorch_ADNI23_3modal import AttentionModel        
...
if __name__ == '__main__':
    ...
    X, y = np.load('../volume_student/surface/ADNI23/data_fsaverage.npy').astype('float32'), np.load('../volume_student/surface/ADNI23/labels.npy') #ADNI23
    ...
    log_path = './logs/q_net_and_seed{}_adni23_3modal'.format(seed)


    weight_path = './weights/q_net_and_seed{}_adni23_3modal'.format(seed)
    ...
    for i, task in enumerate(tasks):
        ...
        for train_idx, test_idx in kf.split(X_, y_):
            ...
            '''model = CGModel(hidden=128, args=args, edge_index=edge_index)'''
